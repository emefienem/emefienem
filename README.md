...
- Engineered a multi-role school management system supporting different user types with dashboards, grading, attendance, finance, and communication modules  
- Built a real-time messaging and announcement system using WebSockets across enterprise user groups  
- Developed a document management system with versioning, folder hierarchy, and permission-based access control  
- Implemented Redis caching and audit logging systems to improve performance and system traceability  
- Co-developed Version 2 of the Nigeria Civil Aviation Authority (NCAA) Consumer Protection Portal  
- Collaborated with frontend engineers and cross-functional teams to deliver production-grade systems  
